...
HuskSync will identify this and safely prevent the synchronization from occurring. Your Spigot servers must be running the same version of both Minecraft and HuskSync.
